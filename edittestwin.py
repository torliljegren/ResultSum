...
class EditTestWin(object):
    ...
    def __init__(self, parent, test: Test, name=None, index=0):
        ...
        ttk.Label(self.middleframe, text='varav C/A-Poäng').grid(row=4, column=2, columnspan=2, sticky=tk.W)
        ...
        self.DCentry.grid(row=5, column=2, pady=(0, yp), sticky=tk.W)
        ...
        ttk.Label(self.middleframe, text='varav C/A-Poäng').grid(row=6, column=2, columnspan=2, sticky=tk.W)
        # create Stringvars and entries
        ...
        self.CCentry.grid(row=7, column=2, pady=(0, yp), sticky=tk.W)
        ...
        ttk.Label(self.middleframe, text='varav A-Poäng').grid(row=8, column=2, columnspan=2, sticky=tk.W)
        # create Stringvars and entries
        ...
        self.BAentry.grid(row=9, column=2, pady=(0, yp), sticky=tk.W)
        ...
        ttk.Label(self.middleframe, text='varav A-Poäng').grid(row=10, column=2, columnspan=2, sticky=tk.W)
        # create Stringvars and entries
        ...
        self.AAentry.grid(row=11, column=2, pady=(0, yp), sticky=tk.W)
